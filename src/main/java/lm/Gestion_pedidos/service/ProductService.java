...
/**
 * Clase de servicio `ProductService` que gestiona las operaciones relacionadas con la entidad `Product`.
 * <p>
 ...
 * es responsable de interactuar con el repositorio de Productos (`ProductRepository`).
 * </p>
 * <p>
 * La clase utiliza la anotación {@link org.springframework.beans.factory.annotation.Autowired @Autowired} 
 * para inyectar automáticamente la interfaz del repositorio de Productos (`ProductRepository`).
